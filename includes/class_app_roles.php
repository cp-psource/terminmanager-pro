...
class App_Roles {
	...
	public static function get_all_contexts () {
		return apply_filters('app-capabilities-contexts', array(
			self::CTX_STAFF => __('Optionen für die Dienstleisteransicht', 'appointments'),
			self::CTX_TUTORIAL => __('Tutorial', 'appointments'),
			self::CTX_PAGE_APPOINTMENTS => __('Terminseite', 'appointments'),
			self::CTX_PAGE_TRANSACTIONS => __('Seite Transaktionen', 'appointments'),
			self::CTX_PAGE_SETTINGS => __('Einstellungsseite', 'appointments'),
			self::CTX_PAGE_SHORTCODES => __('Shortcodes-Seite', 'appointments'),
			self::CTX_PAGE_FAQ => __('FAQ Seite', 'appointments'),
