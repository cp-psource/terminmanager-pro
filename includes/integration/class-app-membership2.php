...
class Appointments_Integration_Membership2 {
	...
	public function settings_form( $options, $use_payments ) {
		...
		<tr class="payment_row" style="<?php echo $row_style; ?>border-top: 1px solid lightgrey;">
			...
			printf(
				__( 'Die folgenden Felder erfordern das %s -Plugin.', 'appointments' ),
				'<a href="https://n3rds.work/piestingtal-source-project/ps-mitglieder-plugin/" target="_blank">PS Mitgliedschaften</a>'
			);
			?></span>
			</td>
		</tr>
		<tr class="payment_row" style="<?php echo $row_style; ?>">
			<th scope="row"><?php _e( 'PS Mitgliedschaften Integration', 'appointments' ); ?></th>
			<td colspan="2">
			<table class="ms-membership-list">
				<tr>
					<th class="ms-row-label">
						<?php _e( 'Mitgliedschaft', 'appointments' ); ?>
					</th>
					<th class="ms-row-discount">
						<?php _e( 'Rabatt', 'appointments' ); ?>
					</th>
					<th class="ms-row-advance">
						<?php _e( 'Keine Vorauszahlung', 'appointments' ); ?>
					</th>
				</tr>
				...
				<tr class="ms-membership-row">
					...
					<td class="ms-row-advance">
						...
						<label for="<?php echo esc_attr( $the_id ); ?>_advance">
							<span class="off"><?php _e( 'Vorauszahlung erforderlich', 'appointments' ); ?></span>
							<span class="on"><?php _e( 'Keine Vorauszahlung', 'appointments' ); ?></span>
						</label>
					</td>
				</tr>
				<?php endforeach; ?>
