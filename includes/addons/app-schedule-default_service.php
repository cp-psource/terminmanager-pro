<?php
/*
Plugin Name: Standarddienst
Description: Ermöglicht die Auswahl des Standarddienstes für Deine Termine, anstatt immer den zuerst definierten zu verwenden.
...
class App_Schedule_DefaultService {
	...
	public function show_settings () {
		...
		$replacement = $this->_get_replacement();
		?>
		<h3><?php _e( 'Standarddiensteinstellungen', 'appointments' ); ?></h3>
		<table class="form-table">
			<tr valign="top">
				<th scope="row" ><label for="default_service"><?php _e('Standarddienst', 'appointments')?></label></th>
				<td colspan="row">
					<select name="default_service" id="default_service">
						<option value=""><?php _e('Standard', 'appointments'); ?></option>
					...
					<span class="description"><?php _e('Dies ist der Dienst, der als Standarddienst verwendet wird.', 'appointments') ?></span>
				</td>
			</tr>
		</table>
		<?php
