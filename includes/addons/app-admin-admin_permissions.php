<?php
/*
Plugin Name: Administratorrechte
Description: Hier kannst Du auswählen, wer was in Deinem Admin-Backend tun darf.
...
class App_Users_AdminPermissions {
	...
	public function show_settings() {
		...
		?>
		<h3><?php _e( 'Zugriff auf Terminrollen', 'appointments' ) ?></h3>
				...
				<tr>
					...
					<td scope="row">
						<select id="roles-<?php esc_attr_e( $ctx );?>" name="roles[<?php esc_attr_e( $ctx );?>][]" multiple="multiple">
							<option value="" <?php echo (empty( $context_roles ) ? 'selected="selected"' : ''); ?> ><?php _e( 'Standard', 'appointments' ); ?></option>
