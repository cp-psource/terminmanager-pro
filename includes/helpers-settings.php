...
function appointments_get_default_options() {
	...
	$gdpr_show = strtolower( _x( 'Nein', 'Gib "Ja" für die Länder der Europäischen Union ein.', 'appointments' ) );
	...
	return apply_filters( 'appointments_default_options', array(
		...
		'gdpr_checkbox_text'        => __( 'Durch die Verwendung dieses Formulars stimmst Du der Speicherung und Verarbeitung Deiner Daten durch diese Website zu.', 'appointments' ),
		'gdpr_checkbox_alert'       => __( 'Bitte akzeptiere das Kontrollkästchen Datenschutz.', 'appointments' ),
