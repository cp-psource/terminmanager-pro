...
<form action="" method="post" class="add-new-service-provider">
	...
	<table class="form-table">
		<tr>
			<th scope="row">
				<label for="worker-user"><?php esc_html_e( 'Dienstleister', 'appointments' ); ?></label>
			</th>
		...
		<tr>
			...
			<td>
            <input id="worker-dummy" class="switch-button" type="checkbox" name="worker_dummy" data-on="<?php esc_html_e( 'Ja', 'appointments' ); ?>" data-off="<?php esc_html_e( 'Nein', 'appointments' ); ?>" />
			</td>
		</tr>
		<tr>
			<th scope="row">
				<label for="worker-price"><?php esc_html_e( 'Zusätzlicher Preis', 'appointments' ); ?></label>
			</th>
			<td>
		...
		<tr>
			<th scope="row">
				<label for="worker-services"><?php esc_html_e( 'Erbrachte Dienstleistungen', 'appointments' ); ?></label>
			</th>
			<td>
<?php
if ( $services ) {
...
?>
		...
		<tr>
			<th scope="row">
				<label for="worker-page"><?php esc_html_e( 'Beschreibungsseite', 'appointments' ); ?></label>
			</th>
			<td>
	...
	<?php submit_button( esc_html__( 'Speichern', 'appointments' ) ); ?>
</form>
