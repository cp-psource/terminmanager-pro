<form method="get" action="" class="search-form">
	...
	<p class="search-box">
		<label for="app-search-input" class="screen-reader-text"><?php _e('Suche Client','appointments'); ?>:</label>
		<input type="text" id="app-search-input" value="<?php echo esc_attr($s); ?>" name="s" />
		<input type="submit" class="button" value="<?php _e('Suche Client','appointments'); ?>" />
	</p>
	...
	<div class="tablenav top">
		...
		<div class="alignleft actions bulkactions">
			<label for="app_new_status" class="screen-reader-text"><?php _e('Bulk Statusänderung','appointments'); ?></label>
			<select name="app_new_status" id="app_new_status" style='float:none;'>
				<option value=""><?php _e('Bulk Statusänderung','appointments'); ?></option>
			...
			<input type="submit" name="bulk_status" class="button app-change-status-btn" value="<?php _e('Status ändern','appointments'); ?>" />
		</div>

		<div class="alignleft actions">

			<label for="app_service_id" class="screen-reader-text"><?php _e('Filter nach Service','appointments'); ?></label>
			<select name="app_service_id" id="app_service_id">
				<option value=""><?php _e('Filter nach Service','appointments'); ?></option>
			...
			<label for="app_provider_id" class="screen-reader-text"><?php _e('Filter nach Serviceprovider','appointments'); ?></label>
			<select name="app_provider_id" id="app_provider_id" style='float:none;'>
				<option value=""><?php _e('Filter nach Serviceprovider','appointments'); ?></option>
			...
			<input type="submit" class="button" name="filter_reset_action" value="<?php _e('Filter zurücksetzen','appointments'); ?>" />
		</div>
